...
var dcbat = props.globals.getNode("/systems/electrical/batt-volts");
var dc1 = props.globals.getNode("/systems/electrical/left-bus");
var dc2 = props.globals.getNode("/systems/electrical/right-bus");
...
var canvas_IESI_base = {
	...
	update: func() {
		if (dcbat.getValue() >= 22 or dc1.getValue() >= 22 or dc2.getValue() >= 22) {
			IESI.page.show();
			IESI.update();
...
setlistener("sim/signals/fdm-initialized", func {
	...
	IESI = canvas_IESI.new(group_IESI, "Aircraft/ec135/Models/instrumentation/IESI/res/iesi.svg");
