...
var canvas_PFD = {
	new: func(canvas_group, instance)
	{
		...
		canvas.parsesvg(canvas_group, "Aircraft/ec135/Models/instrumentation/EUcopter-mfd/pfd.svg", {'font-mapper': font_mapper});
...
var pfdListener = setlistener("sim/signals/fdm-initialized", func () {
	...
	pfd1_display.addPlacement({"node": "FNDScreen"});
